...
CREATE TABLE Bruker (brukernavn VARCHAR(255) NOT NULL PRIMARY KEY, passord VARCHAR(255) NOT NULL, rollenavn VARCHAR(255) NOT NULL, authtoken VARCHAR(255), CONSTRAINT fk_rolle_navn FOREIGN KEY (rollenavn) REFERENCES Rolle(navn));
-- ROLLER

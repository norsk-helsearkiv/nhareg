angular.module('nha.register')
    ...
    .controller('RegisterDiagnosisCtrl', function ($scope, httpService, errorService, diagnosisService, modalService) {
        ...
        $scope.fjernDiagnose = function (diagnose) {
            ...
            httpService.deleteData("pasientjournaler/" + $scope.pasientjournalDTO.persondata.uuid + "/diagnoser", diagnose)
                .success(function (data, status, headers, config) {
        ...
        $scope.update = function (diagnose) {
            ...
            $scope.feilmeldinger = [];
            httpService.update("pasientjournaler/" + $scope.pasientjournalDTO.persondata.uuid + "/diagnoser", diagnose)
                .success(function (data, status, headers, config) {

...
.controller( 'ListCtrl', ["$scope", "$location", "listService", "httpService", "errorService", "modalService", "$filter", "journalService", function HomeController($scope, $location, listService, httpService, errorService, modalService, $filter, journalService) {

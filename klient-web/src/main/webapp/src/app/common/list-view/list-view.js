...
.controller( 'ListCtrl', ["$scope", "$location", "listService", "httpService", "errorService", "modalService", "$filter", "registreringService", function HomeController($scope, $location, listService, httpService, errorService, modalService, $filter, registreringService) {
  var antall = 15;
  $scope.$watch(

...
.controller( 'HomeCtrl', ["$scope", "$location", "$filter", "httpService", "errorService", "listService", "modalService", "$modal", "avleveringerService", function HomeController($scope, $location, $filter, httpService, errorService, listService, modalService, $modal, avleveringerService) {

angular.module('templates-app', ['common/http-service/error-modal-400.tpl.html', 'common/http-service/error-modal-404.tpl.html', 'common/http-service/error-modal-500.tpl.html', 'common/list-view/list-view.tpl.html', 'common/modal-service/delete-modal.tpl.html', 'home/home.tpl.html', 'home/modal-avlevering-add.tpl.html', 'login/login.tpl.html', 'registrering/registrering.tpl.html']);
...
angular.module("common/modal-service/delete-modal.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("common/modal-service/delete-modal.tpl.html",
    ...
    "<div class=\"modal-body\">\n" +
    "    <p>\n" +
    "        {{'modal.delete.SIKKER' | translate}} {{ element }} {{'modal.delete.MED_ID' | translate}} {{ id }} ?\n" +
    "    </p>\n" +
    "</div>\n" +
    "\n" +
    "<div class=\"modal-footer\">\n" +
...
angular.module("home/home.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("home/home.tpl.html",
    ...
    "            <a href=\"\"><button class=\"icon icon-padding-right icon-delete\" data-ng-click=\"actionDelete(text.avtale, avtale.avtaleidentifikator)\" tooltip=\"{{text.tooltip.deleteElement}}\"></button>{{ avtale.avtalebeskrivelse }}</a>\n" +
    "        </li>\n" +
    "      </ul>\n" +
    "    </div>\n" +
    "\n" +
    ...
    "      </div>\n" +
    "      \n" +
    "      <h2 class=\"sub-header\">{{ 'home.AVLEVERINGER' | translate }}<small> {{ 'home.FOR' | translate }} {{ valgtAvtale.avtalebeskrivelse }}</small><button class=\"right btn btn-success\" data-ng-click=\"leggTilAvlevering()\">{{ 'common.LEGG_TIL' | translate }}</button></h2>\n" +
    "      <div class=\"table-responsive\">\n" +
    "        <table class=\"table table-striped\">\n" +
    "          <thead>\n" +
    "            <tr>\n" +
    ...
    "              <td>\n" +
    "                <button class=\"icon icon-list\" data-ng-click=\"actionList(avlevering)\" tooltip=\"{{text.tooltip.list}}\"></button>\n" +
    ...
    "                <button class=\"icon icon-padding-left icon-delete\" data-ng-click=\"actionDelete(text.avlevering, avlevering.avleveringsidentifikator)\" tooltip=\"{{text.tooltip.deleteElement}}\"></button>\n" +
    "              </td>\n" +
    "            </tr>\n" +
    "          </tbody>\n" +
    "        </table>\n" +
...
angular.module("home/modal-avlevering-add.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("home/modal-avlevering-add.tpl.html",
    "<div class=\"modal-header\">\n" +
